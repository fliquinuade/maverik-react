...
const QuoteSwiper = () => {
  return <Swiper className="h-100" modules={[Autoplay, Pagination]} pagination={{
    el: ".swiper-pagination",
    clickable: true
  }} autoplay>

      {quotesData.map((quote, idx) => <SwiperSlide key={idx}>
          <Card className="rounded-0 h-100" data-bs-theme="dark" style={{
