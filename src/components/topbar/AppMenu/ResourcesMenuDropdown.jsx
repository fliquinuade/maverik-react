...
const ResourcesMenuDropdown = () => {
  ...
  return <Dropdown as={'li'} className="nav-item dropdown dropdown-fullwidth">
      <DropdownToggle as={Link} to="" variant='link' className="nav-link mb-0 arrow-none d-flex w-100 justify-content-between align-items-center dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        Resources
      ...
      <div className="dropdown-menu py-0">
        <Row className="p-2 p-sm-4">
          ...
          <Col md={6} xl={4} xxl={5} className="h-100">
            ...
            const Icon = item.icon;
            return <DropdownItem key={idx} as={'div'} className="bg-light-hover d-flex align-items-center justify-content-between position-relative text-wrap py-3">
