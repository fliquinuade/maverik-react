...
const Footer3 = () => {
  return <footer className="bg-dark position-relative overflow-hidden pt-6" data-bs-theme="dark">
      <Container className="position-relative mt-5">
        <Row className="g-4">
            ...
            <Row className="g-0">
              <Col lg={6}>
                <ul className="nav flex-column">
                  ...
                  {quickLinks2.map((item, idx) => <li key={(item.link ?? '') + idx} className="nav-item">
              ...
              <Col lg={6}>
                <ul className="nav flex-column">
                  ...
                  {quickLinks4.map((item, idx) => <li key={(item.link ?? '') + idx} className="nav-item">
          ...
          <Col sm={6} md={4} lg={4} xl={3}>
            ...
            const Icon = item.icon;
            return <div key={item.title + idx} className="position-relative d-flex align-items-center py-2 my-2">
        ...
        <Row className="g-4 align-items-center">
          ...
          const Icon = item.icon;
          return <Col sm={6} md={4} xl={3} key={item.title + idx} className="d-flex justify-content-md-center">
